...
MAIL_PORT = 465  # 端口
MAIL_USE_SSL = True
MAIL_USERNAME = '362641643@qq.com'  # 邮箱账号
MAIL_PASSWORD = 'tercdhyvdaygbhed'  # 邮箱密码
...
def send_mail(to, sub, link):
    msg = Message('学生信息管理系统的邮件来啦', sender=(MAIL_PASSWORD, MAIL_USERNAME), recipients=[to])
    msg.body = sub + link
...
def add(id):
    ...
    if form.validate_on_submit():
        # 构建新学生并保存
        l = [form.stu_id.data, form.name.data,
